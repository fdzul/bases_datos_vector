...
La base de datos de la vigilancia entomológica con ovitrampas, cuenta con más de 100 millones de registros ($102,089,940$) a lo largo del periodo de estudio(2012-2024, excepto 2020, debido a que por la pandemia de COVID no se instalaron las ovitrampas)


```{r, echo=FALSE, fig.cap= "Figura 3. Número de estados, municipios y localidades con ovitrampas en México"}
...
```{r, echo=FALSE, fig.cap= "Figura 4. Distribución de localidaes con ovitrampas en el 2024"}
